                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($contacto['nombre_contacto']) ?></td>
                            <td>
                                <button class="btn btn-warning btn-sm edit-btn" data-id="<?= $contacto['id'] ?>" data-name="<?= $contacto['nombre_contacto'] ?>" data-type="contacto">Editar</button>
                                <button class="btn btn-danger btn-sm delete-btn" data-id="<?= $contacto['id'] ?>" data-type="contacto">Eliminar</button>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <div class="modal-body">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= htmlspecialchars($estatus['id']) ?></td>
                            <td><?= htmlspecialchars($estatus['nombre_estatus']) ?></td>
                            <td>
                                <button class="btn btn-warning btn-sm edit-btn" data-id="<?= $estatus['id'] ?>" data-name="<?= $estatus['nombre_estatus'] ?>" data-type="estatus">Editar</button>
                                <button class="btn btn-danger btn-sm delete-btn" data-id="<?= $estatus['id'] ?>" data-type="estatus">Eliminar</button>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <div class="modal-body">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= htmlspecialchars($gerente['id']) ?></td>
                            <td><?= htmlspecialchars($gerente['nombre_gerente']) ?></td>
                            <td>
                                <button class="btn btn-warning btn-sm edit-btn" data-id="<?= $gerente['id'] ?>" data-name="<?= $gerente['nombre_gerente'] ?>" data-type="gerente">Editar</button>
                                <button class="btn btn-danger btn-sm delete-btn" data-id="<?= $gerente['id'] ?>" data-type="gerente">Eliminar</button>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm edit-btn" data-id="<?= $periodo['id'] ?>" data-name="<?= $periodo['nombre_periodo'] ?>" data-type="periodo">Editar</button>
                                <button class="btn btn-danger btn-sm delete-btn" data-id="<?= $periodo['id'] ?>" data-type="periodo">Eliminar</button>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
